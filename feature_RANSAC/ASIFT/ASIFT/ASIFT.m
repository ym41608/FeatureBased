...
function [tarframes, scrframes] = ASIFT(file_img1, file_img2, imgOutVert, imgOutHori, matchings, keys1, keys2, flag_resize)
...
delete(imgOutVert, imgOutHori, matchings, keys1, keys2, 'tmpASIFTinput1.png', 'tmpASIFTinput2.png');
